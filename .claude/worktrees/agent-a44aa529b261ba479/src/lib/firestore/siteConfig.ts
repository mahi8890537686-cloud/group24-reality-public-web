...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  // Map embed uses the main (Behror) office by default — this is the locally
  // relevant address for Behror/Neemrana/Kotputli search intent, not the
  // Gurugram head office.
  mapEmbedQuery: 'AA-111+Somnath+City+Near+Goonti+Flyover+Delhi+Jaipur+Highway+Behror+Rajasthan+301701',
