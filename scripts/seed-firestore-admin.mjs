// Seed script using Firebase Admin SDK — bypasses security rules
// Run with: node scripts/seed-firestore-admin.mjs
...
const properties = [
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-10')),
    isFeatured: true,
  ...
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-15')),
    isFeatured: true,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-20')),
    isFeatured: true,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-22')),
    isFeatured: true,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-24')),
    isFeatured: true,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-25')),
    isFeatured: false,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-01-28')),
    isFeatured: true,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-02-01')),
    isFeatured: false,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-02-05')),
    isFeatured: false,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-02-08')),
    isFeatured: false,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-02-10')),
    isFeatured: false,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
  {
    ...
    postedAt: Timestamp.fromDate(new Date('2026-02-12')),
    isFeatured: true,
    reraNumber: 'RAJ/P/XXXX/XXXX [DEMO]',
  },
];
...
async function seed() {
  console.log('🌱 Starting Firestore seed for group24reality-web-2f3fd (Admin SDK)...\n');
  ...
  for (const property of properties) {
    const ref = await col.add(property);
    count++;
