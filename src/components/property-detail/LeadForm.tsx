...
export default function LeadForm({ propertyTitle, propertySlug }: LeadFormProps) {
  ...
  return (
    <div className="bg-gold rounded-2xl p-6 shadow-sm text-ink">
      ...
      <p className="text-ink/75 font-inter text-sm mb-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-ink hover:bg-charcoal text-surface font-inter font-bold py-3.5 px-6 rounded-xl transition-all duration-200 active:scale-[0.97] disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink"
        >
          {isSubmitting ? (
      ...
      <div className="flex items-center gap-3 my-5">
        ...
        <span className="text-ink/60 text-xs font-inter">or contact directly</span>
        <div className="flex-1 h-px bg-ink/20" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 border border-ink/25 text-ink hover:bg-ink/10 font-inter font-semibold text-sm py-3 px-4 rounded-xl transition-all"
        >
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 bg-ink/10 border border-ink/20 hover:bg-ink/15 text-ink font-inter font-semibold text-sm py-3 px-4 rounded-xl transition-all"
        >
