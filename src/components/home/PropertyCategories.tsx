        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categories.map(({ icon: Icon, label, tagline, description, highlights, href, color, iconBg, iconColor }) => (
            <StaggerItem key={label}>
              <div className={`group bg-gradient-to-br ${color} bg-gold-soft border border-gold/30 rounded-2xl p-7 hover:shadow-xl transition-all duration-300 h-full flex flex-col`}>
