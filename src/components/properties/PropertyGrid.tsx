  ...
  if (properties.length === 0) {
    return (
      <div className="py-20 flex flex-col items-center justify-center text-center gap-4">
        ...
        <Link
          href="/properties"
          className="mt-2 bg-gold hover:bg-gold-dark text-ink font-inter font-semibold px-6 py-3 rounded-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
        >
          Clear All Filters
        </Link>
      </div>
