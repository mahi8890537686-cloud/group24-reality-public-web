...
export const metadata: Metadata = buildMetadata({
  title: 'Real Estate in Behror, Neemrana & Kotputli | Group 24 Reality',
  description:
    'Explore investment potential of Behror, Neemrana, and Kotputli in Rajasthan. Find plots, villas, and flats with local investment analysis, connectivity details, and infrastructure overview from Group 24 Reality.',
...
export default function LocationsPage() {
  return (
    <>
      ...
      {locations.map((loc, i) => (
        <div key={loc.key} className={i % 2 === 0 ? 'bg-white' : 'bg-sand-50'}>
